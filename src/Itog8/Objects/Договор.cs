...
namespace IIS.Itog8
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog8.Статус fСтатус;
        
        private IIS.Itog8.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Itog8.Клиент fКлиент;
        
        private IIS.Itog8.Длительность fДлительность;
        
        private IIS.Itog8.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Itog8.Статус Статус
        {
            get
            {
                ...
                IIS.Itog8.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog8.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog8.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog8.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog8.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Itog8.Длительность Длительность
        {
            get
            {
                ...
                IIS.Itog8.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog8.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog8.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog8.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog8.Договор));
                }
            }
        }
    }
