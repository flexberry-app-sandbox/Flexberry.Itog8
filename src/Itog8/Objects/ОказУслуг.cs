...
namespace IIS.Itog8
{
    ...
    [View("ОказУслугE", new string[] {
            ...
            "Услуги.Наименование",
            "Услуги.ЗатрВремя",
            "Услуги.ЗатрВремя.Наименование as \'Время\'"})]
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog8.Договор fДоговор;
        
        private IIS.Itog8.Услуги fУслуги;
        
        private IIS.Itog8.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Itog8.Договор Договор
        {
            get
            {
                ...
                IIS.Itog8.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Itog8.Услуги Услуги
        {
            get
            {
                ...
                IIS.Itog8.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itog8.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Itog8.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Itog8.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Itog8.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itog8.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Itog8.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Itog8.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Itog8.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Itog8.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itog8.ОказУслуг dataobject)
        {
