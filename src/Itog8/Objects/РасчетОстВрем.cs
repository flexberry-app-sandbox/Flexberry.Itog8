...
namespace IIS.Itog8
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog8.DetailArrayOfОказУслуг fОказУсл;
        ...
        public virtual IIS.Itog8.DetailArrayOfОказУслуг ОказУсл
        {
            get
            {
                ...
                {
                    this.fОказУсл = new IIS.Itog8.DetailArrayOfОказУслуг(this);
                }
                IIS.Itog8.DetailArrayOfОказУслуг result = this.fОказУсл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Itog8.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Itog8.РасчетОстВрем));
                }
            }
        }
    }
